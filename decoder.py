...
from transformer import LayerNorm, ACT2FN
...
class DecoderModel(nn.Module):
    ...
    def forward(self, label_input, encoder_outs=None, answer_mask=None, encoder_mask=None):
        ...
        extended_encoder_mask = extended_encoder_mask.to(dtype=encoder_outs.dtype) # fp16 compatibility
        extended_encoder_mask = (1.0 - extended_encoder_mask) * -10000.0

        extended_answer_mask = answer_mask.unsqueeze(1).unsqueeze(2)
        extended_answer_mask = extended_answer_mask.to(dtype=encoder_outs.dtype)  # fp16 compatibility
